  ...
  (
      ...
      cells.push(
        <button
          ...
          className={cn(
            ...
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#004098]",
            !isSelected &&
              !disabled &&
              "hover:bg-[#F1F5F9] dark:hover:bg-[#334155]",
            isToday &&
              !isSelected &&
              "font-bold border border-[#004098] dark:border-[#5286E8]",
            isSelected &&
              "bg-[#004098] text-white dark:bg-[#1A5BC8]",
            disabled &&
              "text-[#CBD5E1] dark:text-[#475569] pointer-events-none",
            !isSelected &&
              !disabled &&
              isSunday &&
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] rounded-md p-3 w-fit",
          className
        )}
        {...props}
      >
        ...
        <div className="flex items-center justify-between mb-2">
          <button
            ...
            aria-label="이전 달"
            className="inline-flex items-center justify-center h-8 w-8 rounded-md text-[#64748B] hover:text-[#334155] dark:text-[#94A3B8] dark:hover:text-[#E2E8F0] transition-colors"
          >
            <svg
              className="h-4 w-4"
