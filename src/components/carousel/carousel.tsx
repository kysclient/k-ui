        ...
        {Array.from({ length: total }, (_, i) => (
          <button
            ...
            className={cn(
              ...
              current === i
                ? "bg-krds-primary dark:bg-krds-primary-400"
                : "bg-krds-gray-300 dark:bg-krds-gray-600"
            )}
          />
        ))}
      </div>
