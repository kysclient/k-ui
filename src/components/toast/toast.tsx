...
const variantStyles: Record<ToastVariant, string> = {
  default:
    "bg-white border-krds-gray-200 text-krds-gray-900 dark:bg-[#1E293B] dark:border-krds-gray-700 dark:text-krds-gray-50",
  success:
    "bg-white border-l-4 border-l-krds-success-600 border-krds-gray-200 text-krds-gray-900 dark:bg-[#1E293B] dark:border-krds-gray-700 dark:text-krds-gray-50 dark:border-l-green-500",
  error:
    "bg-white border-l-4 border-l-krds-error-600 border-krds-gray-200 text-krds-gray-900 dark:bg-[#1E293B] dark:border-krds-gray-700 dark:text-krds-gray-50 dark:border-l-red-500",
  warning:
    "bg-white border-l-4 border-l-krds-warning-600 border-krds-gray-200 text-krds-gray-900 dark:bg-[#1E293B] dark:border-krds-gray-700 dark:text-krds-gray-50 dark:border-l-amber-500",
  info:
    "bg-white border-l-4 border-l-krds-primary-600 border-krds-gray-200 text-krds-gray-900 dark:bg-[#1E293B] dark:border-krds-gray-700 dark:text-krds-gray-50 dark:border-l-sky-500",
};
...
const ToastDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-sm text-krds-gray-500 dark:text-krds-gray-400 mt-1 leading-relaxed", className)} {...props} />
  ),
);
  ...
  ({ className, ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        "text-krds-gray-400 hover:text-krds-gray-600 dark:text-krds-gray-500 dark:hover:text-krds-gray-300",
        "transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-krds-primary-600 focus-visible:ring-offset-2",
        className,
      )}
      {...props}
    >
  ...
  ({ className, ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        "border border-krds-gray-200 bg-transparent text-krds-gray-900 hover:bg-krds-gray-100",
        "dark:border-krds-gray-600 dark:text-krds-gray-50 dark:hover:bg-krds-gray-800",
        "transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-krds-primary-600 focus-visible:ring-offset-2",
        className,
      )}
      {...props}
